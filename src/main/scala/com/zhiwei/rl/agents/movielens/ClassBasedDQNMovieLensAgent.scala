...
import com.zhiwei.types.rltypes.movielens.ClassBasedDQNMovieLensRLType.{Action, Reward, State, Transition, Transitions}
...
object ClassBasedDQNMovieLensAgent {
  def props(
             rLConfig: RLConfigT,
    ...
    Props(
      new ClassBasedDQNMovieLensAgent(
        rLConfig,
        recSysConfig,
        dataSetMacro,
        rLMacro,
...
class ClassBasedDQNMovieLensAgent(
                                   rLConfig: RLConfigT,
